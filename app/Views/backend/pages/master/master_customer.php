...
<!-- Modal -->
<div class="modal fade" id="modal_customer" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" placeholder="0000" id="input_customer_code" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Name IC</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="000000" type="text" id="input_name_ic" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Name TBT</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="Test" type="text" id="input_name_tbt" />
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="card-box mb-30">
            <div class="pb-20">
                ...
                <div class="text-left mb-3">
                    <button id="btn_add_customer" onclick="modal_customer(1,0)" class="btn btn-primary">Add
                        Customer</button>
                </div>

                <table class="table stripe hover nowrap" id="table_master_customer">
                    <thead>
                        <tr>
