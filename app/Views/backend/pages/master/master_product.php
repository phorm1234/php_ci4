...
<!-- Modal -->
<div class="modal fade" id="modal_product" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" placeholder="0000" id="input_product_code" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Product Group</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="000000" type="text" id="input_product_group" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Product Name</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="Test" type="text" id="input_product_name" />
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="card-box mb-30">
            <div class="pb-20">
                ...
                <div class="text-left mb-3">
                    <button id="btn_add_product" onclick="modal_product(1,0)" class="btn btn-primary">Add
                        Product</button>
                </div>

                <table class="table stripe hover nowrap" id="table_master_product">
                    <thead>
                        <tr>
...
// });
$(document).ready(function() {
    // Debugging: Log initialization attempt
    console.log("Document ready. Attempting to initialize DataTable.");

    // Check if DataTable instance exists
    if ($.fn.DataTable.isDataTable('#table_master_product')) {
        // Debugging: Log existing DataTable destruction
        console.log("DataTable already exists. Destroying it.");

        // Destroy the DataTable instance
        $('#table_master_product').DataTable().clear().destroy();
    } else {
        // Debugging: Log no existing DataTable found
        console.log("No existing DataTable found. Proceeding with initialization.");
    }
